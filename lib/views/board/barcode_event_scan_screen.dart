...
class BarcodeEventScanScreen extends StatefulWidget {
  final AppUser appUser;

  const BarcodeEventScanScreen({Key key, this.appUser}) : super(key: key);
  @override
  _BarcodeEventScanScreenState createState() => _BarcodeEventScanScreenState();
}

class _BarcodeEventScanScreenState extends State<BarcodeEventScanScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Pair 2 Attend Event'),
